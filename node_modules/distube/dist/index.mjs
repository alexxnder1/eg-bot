...
var ERROR_MESSAGES = {
  ...
  CANNOT_RESOLVE_SONG: (t) => `Cannot resolve ${inspect(t)} to a Song`,
...
var _Song = class {
  ...
  _patchYouTube(i) {
    ...
    if (info.full === true) {
      ...
      const err = __require("@distube/ytdl-core/lib/utils").playError(info.player_response, [
        "UNPLAYABLE",
        "LIVE_STREAM_OFFLINE",
        "LOGIN_REQUIRED"
      ]);
...
var BaseManager = class extends DisTubeBase {
  constructor() {
    super(...arguments);
    __publicField(this, "collection", new Collection());
  }
  get size() {
...
var DisTubeHandler = class extends DisTubeBase {
  ...
  getYouTubeInfo(url, basic = false) {
    if (basic)
      return ytdl.getBasicInfo(url, this.ytdlOptions);
...
var DisTube = class extends TypedEmitter2 {
